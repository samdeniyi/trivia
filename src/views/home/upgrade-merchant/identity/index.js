            ...
            <ScreenContainer>
                ...
                <Formik
                    ...
                    {({ values, handleChange }) => (
                        ...
                        <Message align={"left"} bottom={"24px"}>Upload a passport photograph.</Message>
                        ...
                        <Message align={"left"} bottom={"24px"}>Select a means of identification and upload the document.</Message>
...
UMAgentIdentityCheck.propTypes = {
    sendUserDocumentsOnUpgrade:  func,
